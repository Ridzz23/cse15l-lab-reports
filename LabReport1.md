...
![Image](ls_folder.png)
> Here the `ls` command is used with a path to a directory of the folder `lecture1/`. This is a valid argument. So, the files and folders which are within `lecture1/` are printed out.
